...
<nav class="" id="navbar">
    <div class="mx-auto px-4 sm:px-6 lg:px-28 py-4 flex justify-between items-center">
        ...
        <div class="flex items-center ">
            ...
            <a href="./" class="text-2xl font-bold uppercase flex items-center"><img src="<?=$base_url?>/assets/favicons/WebLogo02b.png" class="navbar-brand-img h-14 w-14 mr-2" alt="PAMANA LOGO"> <p>PAMANA</p></a>
        </div>
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="hidden lg:flex items-center space-x-4">
                <a href="./" class="<?=  $page === '/_/pamana/' ? $active : $notActive ?> transform transition duration-300 hover:scale-105 hover:overline" data-active="home">Home</a>
                <a href="galleries" class="<?= strpos($page,'galleries') ? $active : $notActive ?> transform transition duration-300 hover:scale-105 hover:overline" data-active="galleries">Site Lists</a>
                <a href="map" value="map" id="navToMap" class="<?= strpos($page,'map') ? $active : $notActive ?> transform transition duration-300 hover:scale-105 hover:overline" data-active="map">Map</a>
                <a href="community" class="<?= strpos($page,'community') ? $active : $notActive ?> transform transition duration-300 hover:scale-105 hover:overline" data-active="community">Community</a>
                ...
                <?php if($isLogin){ ?>
                    <div class="relative group">
                        ...
                        <div class="absolute hidden bg-gray-100 text-gray-800 shadow-lg group-hover:block  -group-hover:bg-primary-500 left-1 rounded z-[10000] mt-3">
                            <a href="settings" class="<?= strpos($page,'settings') ? $active : $notActive ?> w-auto whitespace-nowrap text-sm block px-4 py-2 hover:bg-gray-200 flex items-center hover:overline hover:rounded nav-item"><svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M495.9 166.6c3.2 8.7 .5 18.4-6.4 24.6l-43.3 39.4c1.1 8.3 1.7 16.8 1.7 25.4s-.6 17.1-1.7 25.4l43.3 39.4c6.9 6.2 9.6 15.9 6.4 24.6c-4.4 11.9-9.7 23.3-15.8 34.3l-4.7 8.1c-6.6 11-14 21.4-22.1 31.2c-5.9 7.2-15.7 9.6-24.5 6.8l-55.7-17.7c-13.4 10.3-28.2 18.9-44 25.4l-12.5 57.1c-2 9.1-9 16.3-18.2 17.8c-13.8 2.3-28 3.5-42.5 3.5s-28.7-1.2-42.5-3.5c-9.2-1.5-16.2-8.7-18.2-17.8l-12.5-57.1c-15.8-6.5-30.6-15.1-44-25.4L83.1 425.9c-8.8 2.8-18.6 .3-24.5-6.8c-8.1-9.8-15.5-20.2-22.1-31.2l-4.7-8.1c-6.1-11-11.4-22.4-15.8-34.3c-3.2-8.7-.5-18.4 6.4-24.6l43.3-39.4C64.6 273.1 64 264.6 64 256s.6-17.1 1.7-25.4L22.4 191.2c-6.9-6.2-9.6-15.9-6.4-24.6c4.4-11.9 9.7-23.3 15.8-34.3l4.7-8.1c6.6-11 14-21.4 22.1-31.2c5.9-7.2 15.7-9.6 24.5-6.8l55.7 17.7c13.4-10.3 28.2-18.9 44-25.4l12.5-57.1c2-9.1 9-16.3 18.2-17.8C227.3 1.2 241.5 0 256 0s28.7 1.2 42.5 3.5c9.2 1.5 16.2 8.7 18.2 17.8l12.5 57.1c15.8 6.5 30.6 15.1 44 25.4l55.7-17.7c8.8-2.8 18.6-.3 24.5 6.8c8.1 9.8 15.5 20.2 22.1 31.2l4.7 8.1c6.1 11 11.4 22.4 15.8 34.3zM256 336a80 80 0 1 0 0-160 80 80 0 1 0 0 160z"/></svg>Settings</a>
                            ...
                            <form method="POST" class="m-0">
                                <button type="submit" name="logout" class="w-auto whitespace-nowrap text-sm block px-4 py-2 hover:bg-gray-200 flex items-center hover:overline hover:rounded">
                                    <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M320 32c0-9.9-4.5-19.2-12.3-25.2S289.8-1.4 280.2 1l-179.9 45C79 51.3 64 70.5 64 92.5L64 448l-32 0c-17.7 0-32 14.3-32 32s14.3 32 32 32l64 0 192 0 32 0 0-32 0-448zM256 256c0 17.7-10.7 32-24 32s-24-14.3-24-32s10.7-32 24-32s24 14.3 24 32zm96-128l96 0 0 352c0 17.7 14.3 32 32 32l64 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-32 0 0-320c0-35.3-28.7-64-64-64l-96 0 0 64z"/></svg>
                                    Logout
                                </button>
                            </form>
                        </div>
            ...
            <!-- Mobile menu button -->
            <button id="ellipsesMenuBtn" class="lg:hidden text-2xl">
                    ...
                    <li><?php if ($isLogin) { ?>
                        ...
                        <div class="relative group  flex flex-col items-center  py-2 px-4 flex justify-center">
                                ...
                                <div id="accountDropdownMobileMenu" class="hidden bg-gray-100 text-gray-800 shadow-lg -group-hover:bg-primary-500 right-0 rounded z-[10000] mt-1">
                                    <a id="settingsMobileMenu" href="settings" class="w-auto whitespace-nowrap text-sm block px-4 py-2 hover:bg-gray-200 flex items-center hover:overline hover:rounded    nav-item"><svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M495.9 166.6c3.2 8.7 .5 18.4-6.4 24.6l-43.3 39.4c1.1 8.3 1.7 16.8 1.7 25.4s-.6 17.1-1.7 25.4l43.3 39.4c6.9 6.2 9.6 15.9 6.4 24.6c-4.4 11.9-9.7 23.3-15.8 34.3l-4.7 8.1c-6.6 11-14 21.4-22.1 31.2c-5.9 7.2-15.7 9.6-24.5 6.8l-55.7-17.7c-13.4 10.3-28.2 18.9-44 25.4l-12.5 57.1c-2 9.1-9 16.3-18.2 17.8c-13.8 2.3-28 3.5-42.5 3.5s-28.7-1.2-42.5-3.5c-9.2-1.5-16.2-8.7-18.2-17.8l-12.5-57.1c-15.8-6.5-30.6-15.1-44-25.4L83.1 425.9c-8.8 2.8-18.6 .3-24.5-6.8c-8.1-9.8-15.5-20.2-22.1-31.2l-4.7-8.1c-6.1-11-11.4-22.4-15.8-34.3c-3.2-8.7-.5-18.4 6.4-24.6l43.3-39.4C64.6 273.1 64 264.6 64 256s.6-17.1 1.7-25.4L22.4 191.2c-6.9-6.2-9.6-15.9-6.4-24.6c4.4-11.9 9.7-23.3 15.8-34.3l4.7-8.1c6.6-11 14-21.4 22.1-31.2c5.9-7.2 15.7-9.6 24.5-6.8l55.7 17.7c13.4-10.3 28.2-18.9 44-25.4l12.5-57.1c2-9.1 9-16.3 18.2-17.8C227.3 1.2 241.5 0 256 0s28.7 1.2 42.5 3.5c9.2 1.5 16.2 8.7 18.2 17.8l12.5 57.1c15.8 6.5 30.6 15.1 44 25.4l55.7-17.7c8.8-2.8 18.6-.3 24.5 6.8c8.1 9.8 15.5 20.2 22.1 31.2l4.7 8.1c6.1 11 11.4 22.4 15.8 34.3zM256 336a80 80 0 1 0 0-160 80 80 0 1 0 0 160z"/></svg>Settings</a>
