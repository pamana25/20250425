...
<nav class="" id="navbar">
    <div class="mx-auto px-4 sm:px-6 lg:px-28 py-4 flex justify-between items-center">
        ...
        <div class="flex items-center ">
            ...
            <a href="<?= $base_url ?>" class="text-2xl font-bold uppercase flex items-center"><img src="<?= $base_url ?>assets/favicons/WebLogo02b.png" class="navbar-brand-img h-20 mr-2" id="logo" alt="PAMANA LOGO">
                <!-- <p>PAMANA</p> -->
            </a>
        </div>
            ...
            <div class="hidden lg:flex items-center space-x-6">
                ...
                <?php if ($isLogin) { ?>
                    <div class="relative group">
                        <a class="<?= strpos($page, 'settings') ? $active : $notActive ?> group-hover:text-gray-300 pb-3 hover:overline text-2xl"><i class="fa-regular fa-circle-user"></i></a>
            ...
            <ul class="space-y-2">
                <div class="flex flex-col items-center justify-center border-t border-white mt-4 pt-4">
                    ...
                    <li><?php if ($isLogin) { ?>
                            ...
                            <div class="relative group  flex flex-col items-center  py-2 px-4 justify-center">
                                <a id="accountMobileMenu" href="#" class="pb-4 hover:overline text-2xl"><i class="fa-regular fa-circle-user"></i></a>
