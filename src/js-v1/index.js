  ...
  if (isFixNavPage) {
    ...
    const carouselItems = [
      ...
      },
      {
        ...
        description:
          "Cebu City | Marked Structure, National Historical Commission of the Philippines (NHCP)",
        image:
          "assets/images/hero-image/462566180_884525047210111_4597768570314107772_n.jpg",
      },
    ...
    function createCarouselItems() {
      carouselItems.forEach((item) => {
        ...
        overlay.className =
          "absolute inset-0 bg-black bg-opacity-30 flex flex-col items-center justify-center";
