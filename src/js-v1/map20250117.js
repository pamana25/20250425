document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    async function createAndAddLayers() {
      ...
      console.log('total:',json_LatLonLocalSignificantSites_0.features.length + json_LatLonNCP_10.features.length)
    ...
    <tr>
      <td><strong>${
        feature.properties["Property Name"]
          ? autolinker.link(feature.properties["Property Name"].toLocaleString())
          : ""
      }</strong></td>
    </tr>
    ${
