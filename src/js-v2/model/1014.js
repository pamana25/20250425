//Parish Church of Nuestra Señora del Patrocinio de Maria of Boljoon
...
function init() {
  ...
  const loader = new GLTFLoader().setPath(
    "../public/parish_church_of_nuestra_boljoon/"
  );
  ...
  const glbFiles = [
    ...
    "PLAZA.gltf",
    "RIZAL.gltf",
    "SCUELA_KATOLIKA_HANDRAIL.gltf",
    "SCUELA_KATOLIKA_RAILINGS_1.gltf",
    "SCUELA_KATOLIKA_RAILINGS_2.gltf",
    "SCUELA_KATOLIKA_RAILINGS.gltf",
    "SCUELA_KATOLIKA_ROOF.gltf",
    "SCUELA_KATOLIKA_STAIRS.gltf",
    "SCUELA_KATOLIKA.gltf",
    "STREET_LIGHTS.gltf",
  ];
  const seperateFiles = ["CARS.gltf", "TOWN_ROAD.gltf", "TERRAIN.gltf"];
