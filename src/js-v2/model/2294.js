//Parish Church of Saint Joseph the Carpenter of Nueva Caceres
...
function init() {
  ...
  const loader = new GLTFLoader().setPath("../public/st_joseph/");
  ...
  const glbFiles = [
    ...
    "Bell_tower3.gltf",
    "church.gltf",
    "neighborhood_house.gltf",
    "parish_convent_1.gltf",
    "parish_convent_2.gltf",
    "perimeter_wall.gltf",
    "stonewall_1.gltf",
    "stonewall_2.gltf",
    "stonewall_3.gltf",
  ];
  const seperateFiles = ["others.gltf", "landscape.gltf"];
