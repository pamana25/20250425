       ...
       <div id="carousel" class="relative h-[calc(100vh-110px)] overflow-hidden">
           <div class="absolute inset-0 flex transition-transform duration-500 ease-in-out" id="carouselItemsContainer">
               <!-- Carousel items will be injected here by JavaScript -->
           </div>
           <button id="prevBtn" class="h-full absolute top-1/2 left-4 transform -translate-y-1/2 text-white text-4xl z-10"><i class="fas fa-chevron-left"></i></button>
           <button id="nextBtn" class="h-full absolute top-1/2 right-4 transform -translate-y-1/2 text-white text-4xl z-10"><i class="fas fa-chevron-right"></i></button>
       ...
       <div id="maps" class="bg-white mx-auto px-4 sm:px-6 lg:px-28 py-12">
           <div class="flex flex-col lg:flex-row -mx-4 space-y-8 lg:space-y-0 lg:space-x-4">
               ...
               <button class="w-full lg:w-1/2 px-4 flex flex-col transform transition duration-300  hover:scale-105" value="ncp" id="toMap">
               ...
               <button class="w-full lg:w-1/2 px-4 flex flex-col transform transition duration-300 hover:scale-105" value="lcp" id="toMap">
                   <div class="bg-white rounded-lg shadow-lg overflow-hidden flex-1">
       ...
       <main class="w-full">
           ...
           <section class="mb-12 flex flex-col lg:flex-row items-center space-y-8 lg:space-y-0 lg:space-x-4 px-4 sm:px-6 lg:px-28 py-12" id="join-community">
               <div class="space-y-4 w-full lg:w-1/2 px-4">
                   ...
                   <p class="text-sm text-gray-700">As part of the community, there are ways to help your Local Government Units maintain an updated registry of your local heritage sites. You may nominate structures such as houses, chapels, churches, or schools that are not yet enlisted as a heritage site.
                   </p>
