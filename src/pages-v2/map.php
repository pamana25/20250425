                            ...
                            <div class="space-y-2 relative h-full w-full bg-white pb-auto mb-2">
                                ...
                                <ul id="nationalCulturalList" class="space-y-2 p-2 w-auto">
                                    ...
                                    <li class="flex items-center relative group">
                                        ...
                                        <label onclick="showDialog('dialog11')" class="dialog-hover flex items-center text-sm p-2 rounded transition-colors transform translate duration-400 hover:scale-105 cursor-pointer select-none"><img class="w-6 h-6" src="assets/icons/HistoricalMarker2.png" alt="">
