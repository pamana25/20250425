...
<body>
    <main class="relative">
        ...
        <div class="bg-white border rounded-lg shadow-sm">
            ...
            <div id="drawer" class="absolute top-0 left-0 z-40 h-[calc(100vh-64.8px)] p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-96 z-[9999]" tabindex="-1" aria-labelledby="drawer-label">
                ...
                <button type="button" data-drawer-hide="drawer" aria-controls="drawer" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-6 h-6 absolute top-2 right-3 flex items-center justify-center dark:hover:bg-gray-600 dark:hover:text-white">
                            ...
                            <div class="space-y-2 relative h-full w-full bg-white pb-auto mb-2">
                                ...
                                <ul id="nationalCulturalList" class="space-y-2 p-2 w-auto">
                                    ...
                                    <li class="flex items-center relative group">
                                        ...
                                        <label onclick="showDialog('dialog10')" class="dialog-hover flex items-center text-sm p-2 rounded transition-colors transform translate duration-400 hover:scale-105 cursor-pointer select-none"><img class="w-6 h-6" src="assets/icons/ClassifiedHistoricStructure_Fill-2.svg" alt="">
                                    ...
                                    <li class="flex items-center relative group">
                                        ...
                                        <label onclick-data="showDialog('dialog11')" class="dialog-hover flex items-center text-sm p-2 rounded transition-colors transform translate duration-400 hover:scale-105 cursor-pointer select-none"><img class="w-6 h-6" src="assets/icons/HistoricalMarker2.png" alt="">
    ...
    $dialogs = [
        ...
        ['id' => 'dialog3', 'title' => 'National Historical Shrines', 'content' => 'Cultural property which is hallowed and revered for its history or association, as declared by the NHCP and/or other previous iterations of that cultural agency.'],
        ...
        ['id' => 'dialog8', 'title' => 'Presumed Important Cultural Properties', 'content' => 'Cultural property which is not declared as National Cultural Treasure, UNESCO World Heritage Site, National Historical Shrine, National Historical Landmark, National Historical Monument, or Important Cultural Property but still possesses the characteristic of an Important Cultural Property.'],
        ['id' => 'dialog9', 'title' => 'Registered Properties', 'content' => 'Cultural Property Significant to local culture and history, documented and compiled by a local government unit (LGU) in its own cultural inventory.'],
        ['id' => 'dialog10', 'title' => 'Classified Historic Structures', 'content' => 'Colonial Churches and other Houses of Worship, per NHCP Res. No. 3, s. 1991'],
        ['id' => 'dialog11', 'title' => 'Historical Marker', 'content' => 'No available description.'],

    ];

    foreach ($dialogs as $dialog) {
        echo "<dialog id='{$dialog['id']}' class='dialogs m-auto p-6 rounded-lg max-w-4xl w-1/2 items-center border-0'>
    ...
    <script>
        ...
        console.log("THis is the dialog", dialogs);
        // Register each dialog with the polyfill
